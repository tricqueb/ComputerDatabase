	...
	<li>${error.getMessage()}</li>
		...
		<input type="hidden" id="id" name="id" >
			<div id="nameDiv" class="clearfix">
				...
				<div class="input">
					<input id="name" value="${computerdto.getName()}" class="form-control" type="text" name="name" />
				</div>
			</div>
			<div id="introducedDateDiv class="clearfix">
				<label for="introducedDate">Introduced date:</label>
				<div class="input">
					<input id="introducedDate" value="${computerdto.getIntroduced()}" class="form-control" type="date" name="introducedDate" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])"/>
				</div>
			</div>
			<div id="discontinuedDateDiv class="clearfix">
				<label for="discontinuedDate">Discontinued date:</label>
				<div class="input">
					<input id="discontinuedDate" value="${computerdto.getDiscontinued()}" class="form-control" type="date" name="discontinuedDate" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])"/>
				</div>
			</div>
			<div class="form-group">
